...
export default function AboutSection() {
  return (
    <div className="w-11/12 mx-auto pt-20" id="about">
      ...
      <div className="my-8 flex">
        <div className="basis-1/3 pr-5">
          ...
          <p className="mt-6 text-justify">
            ...
            of technology, especially in Software Engineering and Cyber Security. Currently, I am focusing on
            learning frontend development and plan to study backend development
            in the future to become a proficient fullstack developer.
          </p>
        </div>
        <div className="basis-1/3 border-x px-5">
          <p className="text-center font-semibold text-lg">
