...
export default function Footer() {
  return (
    <div className="bg-[#121212] mt-20" id="contact">
      <div className="w-11/12 mx-auto py-10">
        ...
        <div className="mt-4 flex items-center">
          ...
          <a href="mailto:carloangkisan21@gmail.com" className="ml-3" target="_blank">
            carloangkisan21@gmail.com
          </a>
        </div>
        <div className="mt-1 flex items-center">
          <FaLinkedin className="text-[rgb(135,196,182)] size-4" />
          <a href="https://www.linkedin.com/in/carloangkisan" className="ml-3" target="_blank">
            Carlo Angkisan
          </a>
        </div>
        <div className="mt-1 flex items-center">
          <FaWhatsapp className="text-[rgb(135,196,182)] size-4" />
          <a href="https://wa.me/62895322790395" className="ml-3" target="_blank">
            +62 895-3227-90395
          </a>
        </div>
        <hr className="my-5" />
